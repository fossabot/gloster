...
import { Actor, ActorDestroy, ActorInitialize } from '../../framework';

/**
 * This actor starts the main server.
 */
export class ServerActor extends Actor implements ActorDestroy, ActorInitialize {
   ...
   */
  run(context: Map<string, any>): void {
   ...
   * @param context The context object.
   */
  shutdown(context: Map<string, any>): void {
